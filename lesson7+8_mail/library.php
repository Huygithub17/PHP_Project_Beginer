...
define("SMTP_UNAME", "laptrinhwebphp.huy6@gmail.com"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "vtwwnjrqnzgcsfky"); //Password for SMTP authentication
